export const ui = {
  en: {
    ...
    products: {
      ...
      sinetTitle: 'Sinet — Tennis Tournament Manager',
      sinetDesc: 'An all-in-one platform to run tennis tournaments end to end: registrations, brackets, scheduling and live scoring. Launching soon.',
  ...
  es: {
    ...
    products: {
      ...
      sinetTitle: 'Sinet — Gestor de Torneos de Tenis',
      sinetDesc: 'Una plataforma todo en uno para gestionar torneos de tenis de principio a fin: inscripciones, cuadros, calendario y marcador en vivo. Próximamente.',
